...
*   Standard TFMA metrics and plots
    ([`tfma.metrics.*`](https://tensorflow.github.io/model-analysis/api_docs/python/tfma-metrics))
...
*   Custom TFMA metrics (metrics derived from
    [`tfma.metrics.Metric`](https://tensorflow.github.io/model-analysis/api_docs/python/tfma-metrics#tensorflow_model_analysis.metrics.Metric))
...
[`tfma.MetricsSpec`](https://tensorflow.github.io/model-analysis/api_docs/python/tfma#tensorflow_model_analysis.metricsSpec)
or (2) by creating instances of `tf.keras.metrics.*` and/or `tfma.metrics.*`
classes in python and using
[`tfma.metrics.specs_from_metrics`](https://tensorflow.github.io/model-analysis/api_docs/python/tfma-metrics#tensorflow_model_analysis.metrics.specs_from_metrics)
...
passed
[StandardMetricInputs](https://tensorflow.github.io/model-analysis/api_docs/python/tfma-metrics#tensorflow_model_analysis.metrics.StandardMetricInputs)
...
then the special
[FeaturePreprocessor](https://tensorflow.github.io/model-analysis/api_docs/python/tfma-metrics#tensorflow_model_analysis.metrics.FeaturePreprocessor)

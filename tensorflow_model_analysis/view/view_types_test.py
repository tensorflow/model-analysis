...
class ViewTypesTest(parameterized.TestCase):
    @parameterized.named_parameters(
        ("empty_subkey", None, None, None),
        ("class_id_0", 0, None, None),
        ("class_id_1", 1, None, None),
        ("top_k", None, None, 1),
        ("k", None, 1, None),
    )
    def testEvalResultGetMetrics(self, class_id, k, top_k):
        ...
        slicing_metrics = [
            (overall_slice, {output_name: {sub_key: metrics_overall}}),
            (male_slice, {output_name: {sub_key: metrics_male}}),
        ]
        eval_result = view_types.EvalResult(
            slicing_metrics, None, None, None, None, None, None
        )
        ...
        self.assertListEqual(eval_result.get_slice_names(), [overall_slice, male_slice])

    @parameterized.named_parameters(
        ("empty_subkey", None, None, None),
        ("class_id", 1, None, None),
        ("top_k", None, None, 1),
        ("k", None, 1, None),
    )
    def testEvalResultGetAttributions(self, class_id, k, top_k):
        ...
        attributions = [
            (
                overall_slice,
                {output_name: {sub_key: {metric_name: attributions_overall}}},
            ),
            (male_slice, {output_name: {sub_key: {metric_name: attributions_male}}}),
        ]
        eval_result = view_types.EvalResult(
            None, None, attributions, None, None, None, None
        )
        ...
        self.assertDictEqual(actual_attributions[overall_slice], attributions_overall)
        self.assertDictEqual(actual_attributions[male_slice], attributions_male)

        # Test get_attributions_for_slice()
        self.assertDictEqual(
            eval_result.get_attributions_for_slice(class_id=class_id, k=k, top_k=top_k),
            attributions_overall,
        )
        self.assertDictEqual(

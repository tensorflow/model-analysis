...
class BeamUtilsTest(absltest.TestCase):
    def test_delegated_combine_fn(self):
        ...
        self.assertEqual(
            updated_acc, delegated_combine_fn.add_input(input_acc, input_elem)
        )
        ...
        self.assertEqual(
            merged_acc, delegated_combine_fn.merge_accumulators(input_accs)
        )
        ...
        self.assertEqual(compacted_acc, delegated_combine_fn.compact(acc_to_compact))
        ...
        self.assertEqual(output, delegated_combine_fn.extract_output(acc_to_extract))
        ...
        mock_combine_fn.teardown.assert_called_once_with(

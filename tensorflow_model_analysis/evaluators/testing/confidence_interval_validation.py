...
flags.DEFINE_string("output_dir", None, "existing dir in which to write results")
flags.DEFINE_string(
    "pipeline_options",
    "",
...
def get_regression_scenario() -> Tuple[config_pb2.EvalConfig, _ExampleGeneratorType]:
...
def compute_cis(
    ...
    eval_config.options.confidence_intervals.method = (
        config_pb2.ConfidenceIntervalOptions.ConfidenceIntervalMethod.Value(methodology)
    )

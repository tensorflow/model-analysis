...
class MetricsValidatorTest(
    ...
    def testValidateMetricsMetricTDistributionValueAndThreshold(
        ...
        threshold = config_pb2.MetricThreshold(
            value_threshold=config_pb2.GenericValueThreshold(lower_bound={"value": 0.9})
        )
        eval_config = config_pb2.EvalConfig(
            model_specs=[
                config_pb2.ModelSpec(),
        ...
        expected.metric_validations_per_slice[0].failures[0].metric_threshold.CopyFrom(
            threshold
        )
    ...
    def testValidateMetricsMetricTDistributionChangeAndThreshold(
        ...
        sliced_metrics = (
            slice_key,
            {
                ...
                ): types.ValueWithTDistribution(sample_mean=0.91, unsampled_value=0.6),
                metric_types.MetricKey(
                    name="auc", is_diff=True
                ): types.ValueWithTDistribution(sample_mean=0.1, unsampled_value=0.1),
            },
        )
        result = metrics_validator.validate_metrics(sliced_metrics, eval_config)
        self.assertFalse(result.validation_ok)
    ...
    def testValidateMetricsMetricValueAndThreshold(self, slicing_specs, slice_key):
        threshold = config_pb2.MetricThreshold(
            value_threshold=config_pb2.GenericValueThreshold(upper_bound={"value": 1})
        )
        eval_config = config_pb2.EvalConfig(
            model_specs=[
                config_pb2.ModelSpec(),
    ...
    def testValidateMetricsValueThresholdUpperBoundFail(self, slicing_specs, slice_key):
        threshold = config_pb2.MetricThreshold(
            value_threshold=config_pb2.GenericValueThreshold(upper_bound={"value": 1})
        )
        eval_config = config_pb2.EvalConfig(
    ...
    def testValidateMetricsValueThresholdLowerBoundFail(self, slicing_specs, slice_key):
        threshold = config_pb2.MetricThreshold(
            value_threshold=config_pb2.GenericValueThreshold(lower_bound={"value": 1})
        )
        eval_config = config_pb2.EvalConfig(
            model_specs=[
                config_pb2.ModelSpec(),
    ...
    def testValidateMetricsValueThresholdUpperBoundPass(self, slicing_specs, slice_key):
        threshold = config_pb2.MetricThreshold(
            value_threshold=config_pb2.GenericValueThreshold(upper_bound={"value": 1})
        )
        eval_config = config_pb2.EvalConfig(
    ...
    def testValidateMetricsValueThresholdLowerBoundPass(self, slicing_specs, slice_key):
        threshold = config_pb2.MetricThreshold(
            value_threshold=config_pb2.GenericValueThreshold(lower_bound={"value": 1})
        )
        eval_config = config_pb2.EvalConfig(
    ...
    def testValidateMetricsChangeThresholdAbsoluteFail(self, slicing_specs, slice_key):
        threshold = config_pb2.MetricThreshold(
            change_threshold=config_pb2.GenericChangeThreshold(
                direction=config_pb2.MetricDirection.LOWER_IS_BETTER,
                absolute={"value": -1},
        ...
        sliced_metrics = (
            slice_key,
            {
                ...
                metric_types.MetricKey(name="mean_prediction", is_diff=True): -0.333,
            },
        )
        result = metrics_validator.validate_metrics(sliced_metrics, eval_config)
        self.assertFalse(result.validation_ok)
    ...
    def testValidateMetricsChangeThresholdRelativeFail(self, slicing_specs, slice_key):
        threshold = config_pb2.MetricThreshold(
            change_threshold=config_pb2.GenericChangeThreshold(
                direction=config_pb2.MetricDirection.LOWER_IS_BETTER,
                relative={"value": -2},
    ...
    def testValidateMetricsChangeThresholdAbsolutePass(self, slicing_specs, slice_key):
        threshold = config_pb2.MetricThreshold(
            change_threshold=config_pb2.GenericChangeThreshold(
                direction=config_pb2.MetricDirection.LOWER_IS_BETTER,
                absolute={"value": 0},
    ...
    def testValidateMetricsChangeThresholdRelativePass(self, slicing_specs, slice_key):
        threshold = config_pb2.MetricThreshold(
            change_threshold=config_pb2.GenericChangeThreshold(
                direction=config_pb2.MetricDirection.LOWER_IS_BETTER,
                relative={"value": 0},
    ...
    def testValidateMetricsChangeThresholdEqualPass(self, slicing_specs, slice_key):
        # Change thresholds.
        ...
        sliced_metrics = (
            slice_key,
            {
                ...
                metric_types.MetricKey(name="example_count", model_name="candidate"): 1,
                metric_types.MetricKey(
                    name="weighted_example_count",

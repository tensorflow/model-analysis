...
class TfMetricAccumulatorsTest(test_util.TensorflowModelAnalysisTest):
    def testTFMetricsAccumulator(self):
        ...
        self.assertEqual(acc.get_inputs(0), (["output_1_input_1", "output_1_input_2"],))
        self.assertEqual(
            acc.get_inputs(1),
    ...
    def testTFCompilableMetricsAccumulator(self):
        ...
        acc.add_input(0, np.array([1.0, 0.0]), np.array([0.5, 0.5]), np.array([1.0]))
        acc.add_input(0, np.array([1.0, 1.0]), np.array([0.3, 0.7]), np.array([1.0]))
        acc.add_input(1, np.array([0.0, 0.0]), np.array([0.2, 0.8]), np.array([0.5]))
        acc.add_input(1, np.array([0.0, 1.0]), np.array([0.1, 0.9]), np.array([0.5]))
        acc.add_input(1, np.array([1.0, 1.0]), np.array([0.6, 0.4]), np.array([0.7]))
        self.assertAllClose(
            acc.get_inputs(0),
            (
                np.array([np.array([1.0, 0.0]), np.array([1.0, 1.0])]),
                np.array([np.array([0.5, 0.5]), np.array([0.3, 0.7])]),
        ...
        self.assertAllClose(
            ...
            (
                ...
                np.array(
                    [np.array([0.2, 0.8]), np.array([0.1, 0.9]), np.array([0.6, 0.4])]
                ),
                np.array([np.array([0.5]), np.array([0.5]), np.array([0.7])]),
            ),
        )
    ...
    def testTFCompilableMetricsAccumulatorWithFirstEmptyInput(self):
        ...
        acc.add_input(2, np.array([0.0, 0.0]), np.array([0.2, 0.8]), np.array([0.5]))
        self.assertAllClose(
            acc.get_inputs(1),
            (

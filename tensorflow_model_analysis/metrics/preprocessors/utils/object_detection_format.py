    ...
    for col_name in col_names:
        if dict_to_search and col_name in dict_to_search:
            ...
            if new_cols.ndim == 2:
                ...
                raise ValueError(
                    f"Dimension of input under {col_name}" " should be 1 or 2."
                )
        else:
            if allow_missing_key:
                ...
                raise KeyError(
                    f"Key {col_name} is not found under labels, "
    ...
    for col_name in col_names:
        if dict_to_search and col_name in dict_to_search:
            ...
            if new_cols.ndim == 2:
                ...
                raise ValueError(
                    f"Dimension of input under {col_name} is "
            ...
            if allow_missing_key:
                ...
                raise KeyError(
                    f"Key {col_name} is not found under predictions, "
                    "features, or transformed features of the extracts."
                    "Please set allow_missing_key to True, if you want to "
                    "return empty array instead."
                )
    ...
    if num_rows_key:
        if dict_to_search and num_rows_key in dict_to_search:
            ...
            if not allow_missing_key:
                raise KeyError(
                    f"Key {num_rows_key} is not found under predictions, "
                    "features, or transformed features of the extracts."
                    "Please set allow_missing_key to True, if you want to "

...
_INVERT_BINARY_LOGARITHM_PREPROCESSOR_BASE_NAME = "invert_binary_logarithm_preprocessor"
...
class InvertBinaryLogarithmPreprocessor(metric_types.Preprocessor):
    ...
    def __init__(
        ...
        self._prediction_winsorisation_limit_max = prediction_winsorisation_limit_max

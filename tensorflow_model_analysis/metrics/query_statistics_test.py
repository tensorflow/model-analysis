...
class QueryStatisticsTest(
    ...
    @parameterized.named_parameters(
        ("weighted", True, 1.0 + 2.0 + 3.0, 1 * 2.0 + 3 * 2.0 + 1 * 3.0, 2.0, 3 * 2.0),
        ("unweighted", False, 3.0, 6.0, 1.0, 3.0),
    )
    def testQueryStatistics(
        self,
        example_weighted,
        total_queries,
        total_documents,
        ...
        metrics = query_statistics.QueryStatistics().computations(
            query_key="query", example_weighted=example_weighted
        )[0]
        ...
        query1_example1 = {
            ...
            "features": {"query": np.array(["query1"]), "gain": np.array([1.0])},
        }
        query1_example2 = {
            "labels": np.array([0.0]),
            "predictions": np.array([0.8]),
            "example_weights": np.array([1.0]),
            "features": {"query": np.array(["query1"]), "gain": np.array([0.5])},
        }
        query2_example1 = {
            "labels": np.array([0.0]),
            "predictions": np.array([0.5]),
            "example_weights": np.array([2.0]),
            "features": {"query": np.array(["query2"]), "gain": np.array([0.5])},
        }
        query2_example2 = {
            "labels": np.array([1.0]),
            "predictions": np.array([0.9]),
            "example_weights": np.array([2.0]),
            "features": {"query": np.array(["query2"]), "gain": np.array([1.0])},
        }
        query2_example3 = {
            "labels": np.array([0.0]),
            "predictions": np.array([0.1]),
            "example_weights": np.array([2.0]),
            "features": {"query": np.array(["query2"]), "gain": np.array([0.1])},
        }
        query3_example1 = {
            "labels": np.array([1.0]),
            "predictions": np.array([0.9]),
            "example_weights": np.array([3.0]),
            "features": {"query": np.array(["query3"]), "gain": np.array([1.0])},
        }
        examples = [

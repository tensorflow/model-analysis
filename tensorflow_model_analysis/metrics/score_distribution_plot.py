...
def _extract_prediction_and_weight(
    inputs: metric_types.StandardMetricInputs, **kwargs
    ...
    return metric_util.to_label_prediction_example_weight(modified_inputs, **kwargs)
...
def _confusion_matrix_plot(
    ...
    matrices_computations = binary_confusion_matrices.binary_confusion_matrices(
        ...
        # very long.
        name=(binary_confusion_matrices.BINARY_CONFUSION_MATRICES_NAME + "_" + name),
    ...
    def result(
        ...
        metric_types.MetricKey, binary_confusion_matrices.Matrices
    ]:  # pytype: disable=signature-mismatch  # always-use-return-annotations
        confusion_matrix = (
            metrics[matrices_key].to_proto().confusion_matrix_at_thresholds
        )

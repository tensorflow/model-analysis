...
class MultiClassConfusionMatrixMetricsTest(
    ...
    @parameterized.named_parameters(
        ...
        {
            "testcase_name": "_different_thresholds",
            "left": multi_class_confusion_matrix_metrics.Matrices(
                {
                    0.5: {
        ...
        {
            "testcase_name": "_different_entries",
            "left": multi_class_confusion_matrix_metrics.Matrices(
                {
                    0.5: {
                        multi_class_confusion_matrix_metrics.MatrixEntryKey(
        ...
        {
            "testcase_name": "_same_thresholds_and_entries",
            "left": multi_class_confusion_matrix_metrics.Matrices(
                {
                    0.5: {
                        multi_class_confusion_matrix_metrics.MatrixEntryKey(
        ...
        {
            "testcase_name": "_nonempty_thresholds_and_entries_broadcast",
            "left": multi_class_confusion_matrix_metrics.Matrices(
                {
                    0.5: {
                        multi_class_confusion_matrix_metrics.MatrixEntryKey(
    ...
    @parameterized.named_parameters(
        ("using_default_thresholds", {}), ("setting_thresholds", {"thresholds": [0.5]})
    )
    def testMultiClassConfusionMatrixAtThresholds(self, kwargs):
        computations = (
            multi_class_confusion_matrix_metrics.MultiClassConfusionMatrixAtThresholds(
                **kwargs
    ...
    def testMultiClassConfusionMatrixAtThresholdsWithStringLabels(self):
        computations = multi_class_confusion_matrix_metrics.MultiClassConfusionMatrixAtThresholds().computations(
            example_weighted=True
        )
        matrices = computations[0]
        metrics = computations[1]
        ...
        example1 = {
            ...
            "predictions": {
                "probabilities": np.array(
                    [[1.0000000e00, 6.9407083e-24, 2.7419115e-38, 0.0000000e00]]
                ),

...
class SubKey(NamedTuple("SubKey", [("class_id", int), ("k", int), ("top_k", int)])):
    ...
    def __new__(
        ...
        if (
            ...
            raise ValueError(
                ...
                f"weighted_macro_average should be set: micro_average={micro_average}, "
                f"macro_average={macro_average}, weighted_macro_average={weighted_macro_average}"
            )
...
class AttributionsKey(MetricKey):
    ...
    def to_proto(
        ...
        metrics_for_slice_pb2.AttributionsKey
    ):  # pytype: disable=signature-mismatch  # overriding-return-type-checks
        """Converts key to proto."""

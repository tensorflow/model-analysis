...
class MultiClassConfusionMatrixPlotTest(
    ...
    def testMultiClassConfusionMatrixPlot(self):
        computations = multi_class_confusion_matrix_plot.MultiClassConfusionMatrixPlot().computations(
    ...
    @parameterized.named_parameters(
        ("using_num_thresholds", {"num_thresholds": 3}),
        ("using_thresholds", {"thresholds": [0.0, 0.5, 1.0]}),
    )
    def testMultiClassConfusionMatrixPlotWithThresholds(self, kwargs):
        computations = multi_class_confusion_matrix_plot.MultiClassConfusionMatrixPlot(
            **kwargs
        ).computations()
        matrices = computations[0]
        plot = computations[1]

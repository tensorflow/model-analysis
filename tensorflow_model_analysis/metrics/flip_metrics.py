...
class SymmetricFlipRate(_FlipRateBase):
    ...
    def result(self, flip_counts: _BooleanFlipCountsAccumulator) -> float:
        return (
            flip_counts.num_weighted_neg_to_pos + flip_counts.num_weighted_pos_to_neg
...
class NegToNegFlipRate(_FlipRateBase):
    ...
    def result(self, flip_counts: _BooleanFlipCountsAccumulator) -> float:
        return flip_counts.num_weighted_neg_to_neg / flip_counts.num_weighted_examples
...
class NegToPosFlipRate(_FlipRateBase):
    ...
    def result(self, flip_counts: _BooleanFlipCountsAccumulator) -> float:
        return flip_counts.num_weighted_neg_to_pos / flip_counts.num_weighted_examples
...
class PosToNegFlipRate(_FlipRateBase):
    ...
    def result(self, flip_counts: _BooleanFlipCountsAccumulator) -> float:
        return flip_counts.num_weighted_pos_to_neg / flip_counts.num_weighted_examples
...
class PosToPosFlipRate(_FlipRateBase):
    ...
    def result(self, flip_counts: _BooleanFlipCountsAccumulator) -> float:
        return flip_counts.num_weighted_pos_to_pos / flip_counts.num_weighted_examples

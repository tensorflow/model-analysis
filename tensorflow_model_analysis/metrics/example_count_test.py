...
from tensorflow_model_analysis.metrics import example_count, metric_types, metric_util
from tensorflow_model_analysis.proto import config_pb2
from tensorflow_model_analysis.utils import test_util


class ExampleCountTest(test_util.TensorflowModelAnalysisTest, parameterized.TestCase):
    @parameterized.named_parameters(
        ("unweighted", "", "", False),
        ("basic", "", "", True),
        ("multi-model", "model", "", True),
        ("multi-output", "", "output", True),

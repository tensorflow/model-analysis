...
class ExactMatch(metric_types.Metric):
    ...
    def __init__(self, name: str = EXACT_MATCH_NAME, convert_to: Optional[str] = None):
...
class _ExactMatchAccumulator:
    ...
    def __iadd__(self, other):
        self.total_weighted_exact_match_scores += (
            other.total_weighted_exact_match_scores
        )
...
class _ExactMatchCombiner(beam.CombineFn):
    ...
    def add_input(
        self,
        accumulator: _ExactMatchAccumulator,
        element: metric_types.StandardMetricInputs,
    ) -> _ExactMatchAccumulator:
        for (
            label,
            prediction,
            example_weight,
    ...
    def merge_accumulators(
        self, accumulators: Iterable[_ExactMatchAccumulator]
    ) -> _ExactMatchAccumulator:
    ...
    def extract_output(
        ...
        score = (
            accumulator.total_weighted_exact_match_scores

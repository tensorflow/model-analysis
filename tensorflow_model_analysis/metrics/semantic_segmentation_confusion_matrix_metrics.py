...
from tensorflow_model_analysis.metrics import metric_types, metric_util, preprocessors
...
SEMANTIC_SEGMENTATION_TRUE_POSITIVES_NAME = "semantic_segmentation_true_positives"
SEMANTIC_SEGMENTATION_FALSE_POSITIVES_NAME = "semantic_segmentation_false_positives"
...
SEMANTIC_SEGMENTATION_CONFUSION_MATRIX_NAME = "_semantic_segmentation_confusion_matrix"
...
class _SemanticSegmentationConfusionMatrixCombiner(beam.CombineFn):
    ...
    def extract_output(
        ...
        for class_id, confusion_matrix_matrix in accumulator.items():
            new_key = self._key._replace(sub_key=metric_types.SubKey(class_id=class_id))
...
class SemanticSegmentationTruePositive(SemanticSegmentationConfusionMatrixMetricBase):
...
class SemanticSegmentationFalsePositive(SemanticSegmentationConfusionMatrixMetricBase):
    """Calculates the true postive for semantic segmentation."""

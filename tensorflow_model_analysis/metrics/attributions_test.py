...
class AttributionsTest(test_util.TensorflowModelAnalysisTest, parameterized.TestCase):
    def testHasAttributionsMetrics(self):
        ...
        self.assertTrue(attributions.has_attributions_metrics(specs_with_attributions))
    ...
    def testMeanAttributions(self):
        ...
        metrics = {
            total_attributions_key: {"feature1": 1.0, "feature2": -2.0},
    ...
    def testMeanAbsoluteAttributions(self):
        ...
        example_count_key = metric_types.MetricKey(name="example_count")
        metrics = {
            total_absolute_attributions_key: {"feature1": 1.0, "feature2": 2.0},
            example_count_key: 0.5,
        }
    ...
    @parameterized.named_parameters(
        {
            ...
            "examples": [
                ...
                },
                {
                    ...
                    "predictions": None,
                    "example_weights": np.array(1.0),
                    "attributions": {"feature1": 3.1, "feature2": -3.2},
                },
            ],
            "expected_values": {
            ...
            "examples": [
                {
                    ...
                    "example_weights": np.array(1.0),
                    "attributions": {
                        "model": {"feature1": 11.1, "feature2": -11.2},
                    },
                },
                {
                    "labels": None,
                    ...
                    "example_weights": np.array(1.0),
                    "attributions": {
                        "model": {"feature1": -22.1, "feature2": 22.2},
                    },
                },
                {
                    "labels": None,
                    ...
                    "example_weights": np.array(1.0),
                    "attributions": {
                        "model": {"feature1": 33.1, "feature2": -33.2},
                    },
                },
            ],
            "expected_values": {
            ...
            "examples": [
                {
                    ...
                    "attributions": {
                        "model": {
                            "output": {"feature1": 111.1, "feature2": -111.2},
                        },
                    },
                },
                {
                    ...
                    "attributions": {
                        "model": {
                            "output": {"feature1": -222.1, "feature2": 222.2},
                        },
                    },
                },
                {
                    ...
                    "attributions": {
                        "model": {
                            "output": {"feature1": 333.1, "feature2": -333.2},
                        },
                    },
                },
            ],
    ...
    def testTotalAttributionsWithMultiModelsAndOutputs(
        ...
        with beam.Pipeline() as pipeline:
            ...
            result = (
                ...
                | "ComputeResult"
                >> beam.Map(  # comment to add lamda on own line
    ...
    @parameterized.named_parameters(
        ...
        (
            "class_id",
            metric_types.SubKey(class_id=0),
            {
                "feature1": 6.33,
                "feature2": 6.63,
            },
    ...
    def testTotalAttributionsWithSubKeys(self, sub_key, expected_values):
        computations = attributions.TotalAttributions().computations(sub_keys=[sub_key])
    ...
    def testTotalAbsoluteAttributionsWithMultiModelsAndOutputs(
        ...
        computations = attributions.TotalAbsoluteAttributions().computations(
            model_names=[model_name], output_names=[output_name], example_weighted=True
        )

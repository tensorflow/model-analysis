...
class ObjectDetectionMetricsTest(parameterized.TestCase):
    ...
    def testMetricValuesWithLargerData(self, eval_config, name_list, expected_results):
        extracts = [
            {
                "features": {
                    "labels": np.array(
                        [
                            [
                                [272.1, 200.23, 424.07, 480.0, 2.0],
                                [181.23, 86.28, 208.67, 159.81, 2.0],
                                [174.74, 0.0, 435.78, 220.79, 2.0],
                            ]
                        ]
                    ),
                    "predictions": np.array(
                        [
                            [
                                [271.2, 178.86, 429.52, 459.57, 2.0, 0.64],
                                [178.53, 92.57, 206.39, 159.71, 2.0, 0.38],
                                [167.96, 9.97, 442.79, 235.07, 2.0, 0.95],
                            ]
                        ]
                    ),
                }
            },
            {
                "features": {
                    "labels": np.array(
                        [
                            [
                                [473.07, 395.93, 503.07, 424.6, 1.0],
                                [204.01, 235.08, 264.85, 412.44, 2.0],
                                [0.43, 499.79, 340.22, 606.24, 2.0],
                                [204.42, 304.1, 256.93, 456.86, 2.0],
                            ]
                        ]
                    ),
                    "predictions": np.array(
                        [
                            [
                                [471.15, 398.57, 502.29, 428.26, 1.0, 0.54],
                                [198.53, 242.14, 263.93, 427.51, 2.0, 0.95],
                                [-32.86, 505.75, 338.82, 619.66, 2.0, 0.17],
                                [201.59, 299.39, 258.4, 452.88, 1.0, 0.05],
                            ]
                        ]
                    ),
                }
    ...
    def testMetricValuesWithSplittedData(
        ...
        extracts = [
            {
                "features": {
                    "labels": {
                        ...
                        "ymin": np.array([[200.23, 86.28, 0.0]]),
                        "xmax": np.array([[424.07, 208.67, 435.78]]),
                        "ymax": np.array([[480.0, 159.81, 220.79]]),
                        "class_id": np.array([[2.0, 2.0, 2.0]]),
                    },
                    "predictions": {
                        "bbox": np.array(
                            [
                                [
                                    [271.2, 178.86, 429.52, 459.57],
                        ...
                        "class_id": np.array([[2.0, 2.0, 2.0]]),
                        "scores": np.array([[0.64, 0.38, 0.95]]),
                    },
                }
            },
            {
                "features": {
                    "labels": {
                        ...
                        "class_id": np.array([[1.0, 2.0, 2.0, 2.0]]),
                    },
                    "predictions": {
                        "bbox": np.array(
                            [
                                [
                                    [471.15, 398.57, 502.29, 428.26],
                        ...
                        "class_id": np.array([[1.0, 2.0, 2.0, 1.0]]),
                        "scores": np.array([[0.54, 0.95, 0.17, 0.05]]),
                    },
                }
            },
        ]

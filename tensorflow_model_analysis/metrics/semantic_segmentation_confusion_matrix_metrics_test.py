...
class SegmentationConfusionMatrixTest(parameterized.TestCase):
    def setUp(self):
        ...
        prediction_encoded_image = _encode_image_from_nparray(prediction_image_array)
        ...
        prediction_encoded_image2 = _encode_image_from_nparray(prediction_image_array2)

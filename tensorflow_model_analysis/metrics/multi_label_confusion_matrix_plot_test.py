...
from tensorflow_model_analysis.metrics import (
    metric_types,
    metric_util,
    multi_label_confusion_matrix_plot,
)
...
class MultiLabelConfusionMatrixPlotTest(
    ...
    def testMultiLabelConfusionMatrixPlot(self):
        computation = multi_label_confusion_matrix_plot.MultiLabelConfusionMatrixPlot().computations()[
            0
        ]
    ...
    def testMultiLabelConfusionMatrixPlotWithThresholds(self, kwargs):
        computation = multi_label_confusion_matrix_plot.MultiLabelConfusionMatrixPlot(
            **kwargs

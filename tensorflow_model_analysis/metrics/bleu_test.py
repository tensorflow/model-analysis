...
from tensorflow_model_analysis.metrics import bleu, metric_types, metric_util
...
class BleuTest(test_util.TensorflowModelAnalysisTest, parameterized.TestCase):
    ...
    @parameterized.named_parameters(
        (
            ...
            [
                prediction.upper()
                for prediction in _EXAMPLES["perfect_score"][constants.PREDICTIONS_KEY]
            ],
            False,
            7.58,
        ),
                ...
                with beam.Pipeline() as pipeline:
                    ...
                    def check_result(
                        ...
                        try:
                            ...
                            self.assertAlmostEqual(
                                expected_scores[
                                    inner_len * outer_counter + inner_counter
                                ],
    ...
    def test_bleu_extract_corpus_statistics(self, examples_key, expected_accs):
        ...
        actual_accs = bleu._BleuCombiner(None, "", "", None)._extract_corpus_statistics(
    ...
    def test_bleu_merge_accumulators(self, accs_list, expected_merged_acc):
        actual_merged_acc = bleu._BleuCombiner(None, "", "", None).merge_accumulators(
            accs_list
        )

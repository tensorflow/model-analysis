...
from tensorflow_model_analysis.utils import beam_util, util
...
class FixedSizeSample(metric_types.Metric):
    ...
    def __init__(
        ...
        sampled_key: str,
        size: int,
        name: str = FIXED_SIZE_SAMPLE_NAME,
...
class _FixedSizeSampleCombineFn(beam_util.DelegatingCombineFn):
    ...
    def add_input(
        self, heap: _HeapType, element: metric_types.StandardMetricInputs
    ) -> _HeapType:

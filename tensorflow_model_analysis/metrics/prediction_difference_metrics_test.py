...
class SymmetricPredictionDifferenceTest(absltest.TestCase):
    def testSymmetricPredictionDifference(self):
        ...
        computations = (
            prediction_difference_metrics.SymmetricPredictionDifference().computations(
            ...
            def check_result(got):
                try:
                    ...
                    pd_key = metric_types.MetricKey(
                        name=prediction_difference_metrics.SYMMETRIC_PREDICITON_DIFFERENCE_NAME,

...
class _QueryStatisticsAccumulator:
    ...
    __slots__ = ["total_queries", "total_documents", "min_documents", "max_documents"]
...
class _QueryStatisticsCombiner(beam.CombineFn):
    ...
    def add_input(
        self,
        accumulator: _QueryStatisticsAccumulator,
    ...
    def merge_accumulators(
        ...
        for accumulator in accumulators:
            ...
            result.min_documents = min(result.min_documents, accumulator.min_documents)
            result.max_documents = max(result.max_documents, accumulator.max_documents)
        return result

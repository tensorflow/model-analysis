...
class MetricSpecsTest(tf.test.TestCase):
            ...
            config_pb2.MetricsSpec(
                metrics=[
                    ...
                    config_pb2.MetricConfig(
                        ...
                        config=json.dumps(
                            _maybe_add_fn_name({"name": "mae"}, "mean_absolute_error"),
                            sort_keys=True,
                        ),
                    ),
                ],
    ...
    def testMetricKeysToSkipForConfidenceIntervals(self):
        ...
        self.assertIn(
            metric_types.MetricKey(name="example_count", model_name="model_name1"), keys
        )
        self.assertIn(
            metric_types.MetricKey(
        ...
        self.assertIn(
            metric_types.MetricKey(name="example_count", model_name="model_name2"), keys
        )
        self.assertIn(
            metric_types.MetricKey(
                name="weighted_example_count",
    ...
    def testMetricThresholdsFromMetricsSpecs(self):
        ...
        metrics_specs = [
            config_pb2.MetricsSpec(
                thresholds={
                    ...
                    "mean/label": config_pb2.MetricThreshold(
                        value_threshold=config_pb2.GenericValueThreshold(),
                        change_threshold=config_pb2.GenericChangeThreshold(),
                    ),
                    "mse": config_pb2.MetricThreshold(
                        change_threshold=config_pb2.GenericChangeThreshold()
                    ),
                },
                per_slice_thresholds={
                    "auc": config_pb2.PerSliceMetricThresholds(
                        thresholds=[
                    ...
                    "mean/label": config_pb2.PerSliceMetricThresholds(
                        thresholds=[
                            config_pb2.PerSliceMetricThreshold(
                                slicing_specs=slice_specs,
                                threshold=config_pb2.MetricThreshold(
                ...
                cross_slice_thresholds={
                    "auc": config_pb2.CrossSliceMetricThresholds(
                        thresholds=[
                    ...
                    "mse": config_pb2.CrossSliceMetricThresholds(
                        thresholds=[
                            config_pb2.CrossSliceMetricThreshold(
                                cross_slicing_specs=[
                                    config_pb2.CrossSlicingSpec(
        ...
        expected_keys_and_threshold_counts = {
            ...
            metric_types.MetricKey(name="example_count", model_name="model_name1"): 1,
            metric_types.MetricKey(name="example_count", model_name="model_name2"): 1,
            metric_types.MetricKey(
                name="weighted_example_count",
                model_name="model_name1",
                output_name="output_name1",
    ...
    def testToComputations(self):
        ...
        self.assertIn(
            metric_types.MetricKey(name="example_count", model_name="model_name"), keys
        )
    ...
    def testToComputationsWithMixedAggregationAndNonAggregationMetrics(self):
        computations = metric_specs.to_computations(
            [
                config_pb2.MetricsSpec(
                    metrics=[config_pb2.MetricConfig(class_name="CategoricalAccuracy")]
                ),
                config_pb2.MetricsSpec(

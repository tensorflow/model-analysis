...
class ExtractSliceKeysFn(beam.DoFn):
    ...
    def __init__(self, eval_config: Optional[config_pb2.EvalConfig], materialize: bool):
    ...
    def process(
        ...
        element_copy[constants.SLICE_KEY_TYPES_KEY] = slicer.slice_keys_to_numpy_array(
            unique_slice_keys
        )

...
class CounterfactualPredictionsExtactorTest(
    ...
    @parameterized.named_parameters(
        ...
        },
        {
            ...
            "eval_shared_models": [
                types.EvalSharedModel(model_path="", model_type=constants.TF_KERAS)
            ],
            "cf_configs": {},
        ...
        },
        {
            ...
            "eval_shared_models": [
                types.EvalSharedModel(model_path="", model_type=constants.TF_ESTIMATOR)
            ],
            "cf_configs": {},
    ...
    @parameterized.named_parameters(
        {
            ...
            "model_specs": [
                config_pb2.ModelSpec(name="orig", signature_name="serving_default"),
        ...
        },
        {
            ...
            "model_specs": [config_pb2.ModelSpec(signature_name="serving_default")],
            "cf_configs": {"cf": {"x": "x_cf1"}},
        ...
        },
        {
            ...
            "model_specs": [
                config_pb2.ModelSpec(name="orig", signature_name="serving_default"),
                config_pb2.ModelSpec(name="cf1", signature_name="serving_default"),
                config_pb2.ModelSpec(name="cf2", signature_name="serving_default"),
            ],
        ...
        with beam.Pipeline() as pipeline:
            ...
            def check_result(got):
                try:
                    ...
                    self.assertNotIn(
                        counterfactual_predictions_extractor._TEMP_ORIG_INPUT_KEY,
                        got[0],
                    )

...
from tensorflow_model_analysis.extractors import (
    legacy_input_extractor as input_extractor,
)
            ...
            def check_result(got):
                try:
                    ...
                    self.assertAlmostEqual(
                        got[0][constants.LABELS_KEY], np.array([1.0])
                    )
                    self.assertAlmostEqual(
                    ...
                    self.assertAlmostEqual(
                        got[1][constants.LABELS_KEY], np.array([0.0])
                    )
                    self.assertAlmostEqual(
                    ...
                    self.assertAlmostEqual(
                        got[2][constants.LABELS_KEY], np.array([0.0])
                    )
                    self.assertAlmostEqual(

...
def _ParseExample(extracts: types.Extracts, materialize_columns: bool = True) -> None:
...
def _MaterializeFeatures(
    ...
    if source == constants.FEATURES_PREDICTIONS_LABELS_KEY:
        ...
        _AugmentExtracts(fpl.predictions, constants.PREDICTIONS_KEY, excludes, result)

...
class TFJSPredictExtractorTest(
    ...
    def testTFJSPredictExtractorWithKerasModel(self, multi_model, multi_output):
        ...
        if multi_model:
            model_specs.append(config_pb2.ModelSpec(name="model2", model_type="tf_js"))
        ...
        examples = [
            self._makeExample(input1=0.0, input2=1, input3=b"a", non_model_feature=0),
            self._makeExample(input1=1.0, input2=0, input3=b"b", non_model_feature=1),
        ]
